    ...
    return (
        <div className="container grid grid-cols-1 pt-2 mx-auto">
            <div className="grid grid-cols-1">
                <h4 className='pb-5 text-2xl font-bold'>Categorías para vos</h4>
            </div>
            <div className="grid grid-cols-4 gap-12">
                {categories.map(category => (
                    <div key={category.id} className="bg-indigo-400 rounded-lg px-4 uppercase text-center font-bold text-xl cursor-pointer transition-transform ease-linear duration-100s">
