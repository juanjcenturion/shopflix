        ...
        <nav className="bg-white shadow fixed top-0 w-full z-50">
            <div className="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
                ...
                <div className="flex ml-44 justify-center items-center">
                        ...
                        <button className="bg-gray-800 text-white w-32 h-12 rounded-md rounded-l-none transition duration-300 ease-in-out hover:bg-indigo-500">Buscar</button>
                    </div>
                <div className="md:flex items-center">
                    ...
                    <div className="flex justify-center md:block">
                        <div className=" inline-flex px-2">
                            <a className="relative text-gray-700 transition duration-300 ease-in-out hover:text-indigo-500" href="#">
